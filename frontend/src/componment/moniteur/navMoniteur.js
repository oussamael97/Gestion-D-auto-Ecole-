...
export default function NavMoniteur(){
  const HandleLogout= ()=>{
          ...
          <div className="collapse navbar-collapse " id="navbarNavDropdown">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className="nav-link " aria-current="page" to="/AccueilMoniteur"> Home</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/calendrierMoniteur"> calendrier </Link>
              </li> 
              <li className="nav-item">
                <Link className="nav-link" to="/ListReservation"> List de Reservation</Link>
              </li>
              <div class="dropdown">
